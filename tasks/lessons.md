...
- Studying a reference game does not authorize replacing an established game loop wholesale. Preserve the current feel and architecture unless the user explicitly approves a full implementation swap; use reference code to diagnose specific behavior and change only the requested surface.
