...
- When the request is to use the real/reference game implementation and only change assets, do not reinterpret it as custom physics tuning. Port a license-compatible reference faithfully, preserve its mechanics, and limit product-specific changes to assets and required platform integration.
